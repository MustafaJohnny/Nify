    ...
    <React.Fragment>
      <section className={classes.firstSection}>
        <header className={classes.mainHeaderResult}>
          ...
          <div className={classes.headingArea}>
            <h3 className={classes.newsHeading}>Privacy Policy</h3>
          </div>
        </header>
      </section>
      ...
      <section className={classes.secondSection}>
        <div className={classes.PrivacyContainer}>
          <h1 className={classes.privacyHeadings}>Privacy Policy</h1>
          <p className={classes.privacySpan}>
            ...
            NIFY. By accessing or using our Service, you signify that you have
          ...
          <p className={classes.privacySpan}>
            NIFY (“we,” “our,” or “us”) is committed to protecting your privacy.
            This Privacy Policy explains how your personal information is
            collected, used, and disclosed by NIFY.
          </p>
          <span className={classes.privacySpan}>Updated at 2022-07-24</span>
          ...
          <ul className={classes.privacyUl}>
            ...
            <li>
              Personnel: refers to those individuals who are employed by NIFY or
          ...
          <h1 className={classes.privacyHeadings}>
            When does NIFY use end user information from third parties?
          </h1>
          <p className={classes.privacySpan}>
            NIFY will collect End User Data necessary to provide the NIFY
          ...
          <h1 className={classes.privacyHeadings}>
            When does NIFY use customer information from third parties?
          </h1>
          <p className={classes.privacySpan}>
            ...
            interest in becoming a NIFY customer, we receive information from a
            third party that provides automated fraud detection services to
            NIFY. We also occasionally collect information that is made publicly
          ...
          <p className={classes.privacySpan}>
            NIFY will collect personal information that you submit to us. We may
          ...
          <p className={classes.privacySpan}>
            We keep your information only so long as we need it to provide NIFY
            ...
            with our legal or regulatory obligations, well either remove it from
          ...
          <p className={classes.privacySpan}>
            ...
            information you transmit to NIFY or guarantee that your information
          ...
          <p className={classes.privacySpan}>
            NIFY is incorporated in Ukraine . Information collected via our
          ...
          <h1 className={classes.privacyHeadings}>
            Is the information collected through the NIFY Service secure?
          </h1>
          <p className={classes.privacySpan}>
          ...
          <p className={classes.privacySpan}>
            ...
            information NIFY collects depend on your relationship with NIFY.
          ...
          <h1 className={classes.privacyHeadings}>Personnel</h1>
          <p className={classes.privacySpan}>
            If you are a NIFY worker or applicant, we collect information you
          ...
          <h1 className={classes.privacyHeadings}>Sale of Business</h1>
          <p className={classes.privacySpan}>
            ...
            all of the assets of NIFY or any of its Corporate Affiliates (as
            defined herein), or that portion of NIFY or any of its Corporate
          ...
          <h1 className={classes.privacyHeadings}>Affiliates</h1>
          <p className={classes.privacySpan}>
            ...
            control with NIFY, whether by ownership or otherwise. Any
          ...
          <h1 className={classes.privacyHeadings}>Governing Law</h1>
          <p className={classes.privacySpan}>
            This Privacy Policy is governed by the laws of Ukraine without
          ...
          <p className={classes.privacySpan}>
            The laws of Ukraine , excluding its conflicts of law rules, shall
            govern this Agreement and your use of the app. Your use of the app
            may also be subject to other local, state, national, or
            international laws.
          </p>
          <p className={classes.privacySpan}>
            By using NIFY or contacting us directly, you signify your acceptance
          ...
          <p className={classes.privacySpan}>
            ...
            contain links to other websites not operated or controlled by NIFY.
          ...
          <h1 className={classes.privacyHeadings}>Advertising</h1>
          <p className={classes.privacySpan}>
            This app may contain third party advertisements and links to third
            party sites. NIFY does not make any representation as to the
          ...
          <p className={classes.privacySpan}>
            Advertising keeps NIFY and many of the websites and services you use
          ...
          <p className={classes.privacySpan}>
            ...
            NIFY of the third party sites, goods or services. NIFY takes no
          ...
          <h1 className={classes.privacyHeadings}>Cookies for Advertising</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Payment Details</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Kids' Privacy</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>What is GDPR?</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>What is personal data?</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Why is GDPR important?</h1>
          <p className={classes.privacySpan}>
            ...
            the right thing to do. At NIFY we strongly believe that your data
          ...
          <p className={classes.privacySpan}>
            ...
            rights requirements of GDPR. NIFY processes or stores all personal
          ...
          <h1 className={classes.privacyHeadings}>California Residents</h1>
          <p className={classes.privacySpan}>
          ...
          <span className={classes.privacySpan}>
            Via Email:
            <a rel="noreferrer" href="/cdn-cgi/l/email-protection">
              [email&nbsp;protected]
            </a>
          </span>
        </div>
