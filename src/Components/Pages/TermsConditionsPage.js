    ...
    <React.Fragment>
      <section className={classes.firstSection}>
        <header className={classes.mainHeaderResult}>
          ...
          <div className={classes.headingArea}>
            <h3 className={classes.newsHeading}>Terms & Conditions</h3>
          </div>
        </header>
      </section>
      ...
      <section className={classes.secondSection}>
        <div className={classes.PrivacyContainer}>
          <h1 className={classes.privacyHeadings}>General Terms</h1>
          <p className={classes.privacySpan}>
            By accessing and placing an order with nify, you confirm that you
          ...
          <p className={classes.privacySpan}>
            Under no circumstances shall nify team be liable for any direct,
            indirect, special, incidental or consequential damages, including,
            but not limited to, loss of data or profit, arising out of the use,
            or the inability to use, the materials on this site, even if nify
          ...
          <p className={classes.privacySpan}>
            nify will not be responsible for any outcome that may occur during
          ...
          <p className={classes.privacySpan}>Updated at 2022-07-24</p>

          <h1 className={classes.privacyHeadings}>License</h1>
          <p className={classes.privacySpan}>
            Nify grants you a revocable, non-exclusive, non-transferable,
            limited license to download, install and use the app strictly in
            accordance with the terms of this Agreement.
          </p>
          <p className={classes.privacySpan}>
            These Terms & Conditions are a contract between you and nify
            (referred to in these Terms & Conditions as "nify", "us", "we" or
            "our"), the provider of the nify website and the services accessible
            from the nify website (which are collectively referred to in these
            Terms & Conditions as the "nify Service").
          </p>
          <p className={classes.privacySpan}>
            You are agreeing to be bound by these Terms & Conditions. If you do
            not agree to these Terms & Conditions, please do not use the nify
          ...
          <h1 className={classes.privacyHeadings}>Definitions and key terms</h1>
          <p className={classes.privacySpan}>
          ...
          <ul className={classes.privacyUl}>
            ...
            <li>
              ...
              “our,” it refers to nify llc, sonyachna street, 5 that is
              responsible for your information under this Terms & Conditions.
            </li>
            <li>
              Country: where nify or the owners/founders of nify are based, in
              this case is MD
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit nify and
              use the services.
            </li>
            <li>
              Service: refers to the service provided by nify as described in
            ...
            <li>Website: nify's site, which can be accessed via this URL:</li>
            <li>
              You: a person or entity that is registered with nify to use the
              Services.
            </li>
          </ul>

          <h1 className={classes.privacyHeadings}>Restrictions</h1>
          <p className={classes.privacySpan}>
          ...
          <ul className={classes.privacyUl}>
            ...
            <li>
              ...
              notice of copyright or trademark) of nify or its affiliates,
              partners, suppliers or the licensors of the app.
            </li>
          </ul>
          <h1 className={classes.privacyHeadings}>Return and Refund Policy</h1>
          <p className={classes.privacySpan}>
            Thanks for shopping at nify. We appreciate the fact that you like to
          ...
          <p className={classes.privacySpan}>
            ...
            apply to transactions at nify. We’ll be as brief as our attorneys
            will allow. The main thing to remember is that by placing an order
            or making a purchase at nify, you agree to the terms along with
            nify's Privacy Policy.
          </p>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Your Suggestions</h1>
          <p className={classes.privacySpan}>
            Any feedback, comments, ideas, improvements or suggestions
            (collectively, "Suggestions") provided by you to nify with respect
            to the app shall remain the sole and exclusive property of nify.
          </p>
          <p className={classes.privacySpan}>
            nify shall be free to use, copy, modify, publish, or redistribute
            the Suggestions for any purpose and in any way without any credit or
            any compensation to you.
          </p>

          <h1 className={classes.privacyHeadings}>Your Consent</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Links to Other Websites</h1>
          <p className={classes.privacySpan}>
            ...
            nify. We are not responsible for the content, accuracy or opinions
          ...
          <h1 className={classes.privacyHeadings}>Cookies</h1>
          <p className={classes.privacySpan}>
            nify uses "Cookies" to identify the areas of our website that you
          ...
          <p className={classes.privacySpan}>
            ...
            to users generally at ’s sole discretion, without prior notice to
            you. You may stop using the Service at any time. You do not need to
            specifically inform disables access to your account, you may be
          ...
          <h1 className={classes.privacyHeadings}>Modifications to Our app</h1>
          <p className={classes.privacySpan}>
            nify reserves the right to modify, suspend or discontinue,
          ...
          <h1 className={classes.privacyHeadings}>Updates to Our app</h1>
          <p className={classes.privacySpan}>
            nify may from time to time provide enhancements or improvements to
          ...
          <p className={classes.privacySpan}>
            ...
            of the app. You agree that nify has no obligation to (i) provide any
          ...
          <h1 className={classes.privacyHeadings}>Third-Party Services</h1>
          <p className={classes.privacySpan}>
          ...
          <p className={classes.privacySpan}>
            You acknowledge and agree that nify shall not be responsible for any
            Third-Party Services, including their accuracy, completeness,
            timeliness, validity, copyright compliance, legality, decency,
            quality or any other aspect thereof. nify does not assume and shall
          ...
          <h1 className={classes.privacyHeadings}>Term and Termination</h1>
          <p className={classes.privacySpan}>
            This Agreement shall remain in effect until terminated by you or
            nify.
          </p>
          <p className={classes.privacySpan}>
            Nify may, in its sole discretion, at any time and for any or no
          ...
          <p className={classes.privacySpan}>
            ...
            nify, in the event that you fail to comply with any provision of
          ...
          <p className={classes.privacySpan}>
            Termination of this Agreement will not limit any of nify's rights or
          ...
          <h1 className={classes.privacyHeadings}>Indemnification</h1>
          <p className={classes.privacySpan}>
            You agree to indemnify and hold nify and its parents, subsidiaries,
          ...
          <h1 className={classes.privacyHeadings}>No Warranties</h1>
          <p className={classes.privacySpan}>
            ...
            extent permitted under applicable law, nify, on its own behalf and
            ...
            trade practice. Without limitation to the foregoing, nify provides
          ...
          <p className={classes.privacySpan}>
            Without limiting the foregoing, neither nify nor any nify's provider
            ...
            (ii) that the app will be uninterrupted or error-free; (iii) as to
            ...
            content, or e-mails sent from or on behalf of nify are free of
          ...
          <h1 className={classes.privacyHeadings}>Limitation of Liability</h1>
          <p className={classes.privacySpan}>
            Notwithstanding any damages that you might incur, the entire
            liability of nify and any of its suppliers under any provision of
          ...
          <p className={classes.privacySpan}>
            ...
            nify or its suppliers be liable for any special, incidental,
            ...
            provision of this Agreement), even if nify or any supplier has been
          ...
          <h1 className={classes.privacyHeadings}>Severability</h1>
          <p className={classes.privacySpan}>
          ...
          <p className={classes.privacySpan}>
            ...
            notices published by nify on the Services, shall constitute the
            entire agreement between you and nify concerning the Services. If
            ...
            such term or any other term, and nify's failure to assert any right
            or provision under this Agreement shall not constitute a waiver of
            such right or provision. YOU AND nify AGREE THAT ANY CAUSE OF ACTION
          ...
          <h1 className={classes.privacyHeadings}>Waiver</h1>
          <p className={classes.privacySpan}>
          ...
          <p className={classes.privacySpan}>
            nify reserves the right, at its sole discretion, to modify or
          ...
          <p className={classes.privacySpan}>
            ...
            agree to the new terms, you are no longer authorized to use nify.
          </p>

          <h1 className={classes.privacyHeadings}>Entire Agreement</h1>
          <p className={classes.privacySpan}>
            The Agreement constitutes the entire agreement between you and nify
            regarding your use of the app and supersedes all prior and
            contemporaneous written or oral agreements between you and nify.
          </p>
          <p className={classes.privacySpan}>
            You may be subject to additional terms and conditions that apply
            when you use or purchase other nify's services, which nify will
            provide to you at the time of such use or purchase.
          </p>

          <h1 className={classes.privacyHeadings}>Updates to Our Terms</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Intellectual Property</h1>
          <p className={classes.privacySpan}>
            The app and its entire contents, features and functionality
            (including but not limited to all information, software, text,
            displays, images, video and audio, and the design, selection and
            arrangement thereof), are owned by nify, its licensors or other
            providers of such material and are protected by MD and international
            ...
            or in part, without the express prior written permission of nify,
            unless and except as is expressly provided in these Terms &
            Conditions. Any unauthorized use of the material is prohibited.
          </p>

          <h1 className={classes.privacyHeadings}>Agreement to Arbitrate</h1>
          <p className={classes.privacySpan}>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR nify's INTELLECTUAL
            PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
            other controversy between you and nify concerning the Services or
          ...
          <h1 className={classes.privacyHeadings}>Notice of Dispute</h1>
          <p className={classes.privacySpan}>
            In the event of a dispute, you or nify must give the other a Notice
            ...
            nify will send any Notice of Dispute to you by mail to your address
            if we have it, or otherwise to your email address. You and nify will
            ...
            sixty (60) days, you or nify may commence arbitration.
          </p>

          <h1 className={classes.privacyHeadings}>Binding Arbitration</h1>
          <p className={classes.privacySpan}>
            If you and nify don’t resolve any dispute by informal negotiation,
          ...
          <h1 className={classes.privacyHeadings}>Submissions and Privacy</h1>
          <p className={classes.privacySpan}>
            ...
            property of nify without any compensation or credit to you
            whatsoever. nify and its affiliates shall have no obligations with
          ...
          <h1 className={classes.privacyHeadings}>Promotions</h1>
          <p className={classes.privacySpan}>
            nify may, from time to time, include contests, promotions,
          ...
          <h1 className={classes.privacyHeadings}>Typographical Errors</h1>
          <p className={classes.privacySpan}>
          ...
          <h1 className={classes.privacyHeadings}>Miscellaneous</h1>
          <p className={classes.privacySpan}>
            ...
            signed by an authorized representative of nify. nify will be
            ...
            breach or anticipatory breach by you. nify operates and controls the
            nify Service from its offices in MD. The Service is not intended for
            distribution to or use by any person or entity in any jurisdiction
            or country where such distribution or use would be contrary to law
            or regulation. Accordingly, those persons who choose to access the
            nify Service from other locations do so on their own initiative and
            ...
            include and incorporate the nify Privacy Policy) contains the entire
            understanding, and supersedes all prior understandings, between you
            and nify concerning its subject matter, and cannot be changed or
          ...
          <h1 className={classes.privacyHeadings}>Disclaimer</h1>
          <p className={classes.privacySpan}>
            nify is not responsible for any content, code or any other
            imprecision.
          </p>
          <p className={classes.privacySpan}>
            nify does not provide warranties or guarantees.
          </p>
          <p className={classes.privacySpan}>
            In no event shall nify be liable for any special, direct, indirect,
          ...
          <p className={classes.privacySpan}>
            The nify Service and its contents are provided "as is" and "as
            available" without any warranty or representations of any kind,
            whether express or implied. nify is a distributor and not a
            publisher of the content supplied by third parties; as such, nify
            ...
            provided through or accessible via the nify Service. Without
            limiting the foregoing, nify specifically disclaims all warranties
            and representations in any content transmitted on or in connection
            with the nify Service or on sites that may appear as links on the
            nify Service, or in the products provided as a part of, or otherwise
            in connection with, the nify Service, including without limitation
            any warranties of merchantability, fitness for a particular purpose
            or non-infringement of third party rights. No oral advice or written
            information given by nify or any of its affiliates, employees,
            ...
            notice. Without limiting the foregoing, nify does not warrant that
            the nify Service will be uninterrupted, uncorrupted, timely, or
            error-free.
          </p>

          <h1 className={classes.privacyHeadings}>Contact Us</h1>
          <p className={classes.privacySpan}>
